...
if(abs(TEE-sum) <= 50):
	...
	print("You have eaten less than required.")
	s=(TEE)-sum
	print (sum)
	print ("reward yourself with one of these.")
	...
	print("You shouldn't have eaten these items.")
